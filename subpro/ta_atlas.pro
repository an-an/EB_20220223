...
; ========================================================================
function ta_atlas,wmin,wmax,wstep,wl=wl,liege=liege,spot=spot
...
if !version.os_family eq 'Windows' or !version.os eq 'Win32' then begin
   ...
   pp:	afile=drv0+dir+file
	...
	;afile='/usr/local/lib/atlas/'+file
        ...
        ;afile='/Users/anantetsu/study/program/IDLPRO/data/database/atlas/'+file
        ;afile='/Users/Tetsu/study/program/IDLPRO/data/database/atlas/'+file
        ;afile='/Users/Tetsu/study/program/idl/data/database/atlas/'+file
        ;afile='/data/tanan/atlas/'+file
        afile='./demodata/'+file
endelse
